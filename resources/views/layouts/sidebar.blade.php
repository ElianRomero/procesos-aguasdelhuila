        ...
        <div class="flex flex-col w-56 bg-white rounded-r-3xl shadow-xl overflow-hidden">
            <ul class="flex flex-col py-4">
                ...
                @if (Auth::user()->role_id === 1)
                    ...
                    <li>
                        <a href="{{ route('proponentes.certificados.index') }}"
                            class="flex flex-row items-center h-12 transform hover:translate-x-2 transition-transform ease-in duration-200 text-gray-500 hover:text-gray-800">
                            <span class="inline-flex items-center justify-center h-12 w-12 text-lg text-black">
                            ...
                            <span class="text-sm font-medium text-black">Certificados</span>
                        </a>
                    </li>
                    <li>
                ...
                @if (Auth::user()->role_id === 2)
                    ...
                    <li>
                        <a href="{{ route('invoices.simple-import.form') }}"
                            class="flex flex-row items-center h-12 transform hover:translate-x-2 transition-transform ease-in duration-200 text-gray-500 hover:text-gray-800">
                            <span class="inline-flex items-center justify-center h-12 w-12 text-lg text-black">
                                <img src="/image/proveedor.png" width="24" height="24" alt="">
                            </span>
                            <span class="text-sm font-medium text-black">Importar facturas simplificadas</span>
                        </a>
                    </li>
                    <li>
                        <a href="{{ route('invoices.simple.index') }}"
                            class="flex flex-row items-center h-12 transform hover:translate-x-2 transition-transform ease-in duration-200 text-gray-500 hover:text-gray-800">
                            <span class="inline-flex items-center justify-center h-12 w-12 text-lg text-black">
                                <img src="/image/factura.png" width="24" height="24" alt="">
                            </span>
                            <span class="text-sm font-medium text-black">Facturas simplificadas</span>
                        </a>
                    </li>
                     <li>
