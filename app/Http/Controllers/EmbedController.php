...
class EmbedController extends Controller
{
    public function index()
    {
        ...
        $anios = Proceso::selectRaw('DISTINCT YEAR(fecha) as y')
            ->whereNotNull('fecha')
            ->orderByDesc('y')
            ->pluck('y')
            ->all();
        ...
        return response($view)
            ->header('Content-Security-Policy', "frame-ancestors 'self' https://aguasdelhuila.gov.co https://www.aguasdelhuila.gov.co");
    }
}
